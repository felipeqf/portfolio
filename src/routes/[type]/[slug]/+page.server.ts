...
export const load: PageServerLoad = async ({ params }) => {
    try {
        ...
        const contentDir = join(process.cwd(), normalizedPath);
        ...
        const marked = createMarkedWithHighlight(contentDir, type);
        ...
        return {
            ...
            metadata: {
                ...
                image: metadata.image ? processImagePath(metadata.image, contentDir, type) : ''
            },
            html,
            nextItem
